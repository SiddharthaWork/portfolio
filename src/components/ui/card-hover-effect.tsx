    ...
    >
      {items.map((item, idx) => {
        ...
        >
          ...
          <div className="rounded-md w-full p-4 overflow-hidden bg-black group-hover:ring-2 ring-orange-500 relative z-20 transition-all duration-500 cursor-pointer">
